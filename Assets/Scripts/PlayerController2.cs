...
public class PlayerController2 : MonoBehaviour
{
    ...
    [SerializeField] private Vector3 startPosition2 = new Vector3(25f, -23f, -2.5f); //ステージ1のスタート位置
    ...
    private void Start()
    {
        ...
        _transform.position = startPosition2;
        key2 = GameObject.FindGameObjectWithTag("key2");
        goal2 = GameObject.FindGameObjectWithTag("goal2");
